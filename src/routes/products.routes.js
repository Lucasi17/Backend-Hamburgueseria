...
import productValidate from "../middleware/product.validations";
...
router
  ...
  /* .post(
    [
      ...
      check("productName", "El nombre del producto debe tener entre 2 y 100 caracteres").isLength({min:2, max:10}),
